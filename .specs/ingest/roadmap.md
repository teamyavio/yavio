...
- Fastify/Hono HTTP server setup
...
- CORS configuration for widget requests
- `GET /health` endpoint (liveness: process up; readiness: ClickHouse + PostgreSQL connectivity check)
